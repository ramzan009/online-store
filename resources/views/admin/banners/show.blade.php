            ...
            <tr>
                ...
                <td>
                    ...
                    @elseif ($banner->isModerated())
                        <span style="color: #1a1d20" class="badge badge-success">Ready to Payment</span>
                    @elseif ($banner->isOrdered())
                        <span style="color: #1a1d20" class="badge badge-warning">Waiting for Payment</span>
